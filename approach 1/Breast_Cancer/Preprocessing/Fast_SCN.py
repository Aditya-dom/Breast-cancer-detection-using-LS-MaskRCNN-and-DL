...
def main():
    ...
    if op==1:
        ...
        dirlist = ["/home/Drive2/aditya/Data/Photos/Validation/InSitu/is081.png"]
        for filename in range(len(dirlist)):
            source_filename = dirlist[0]
            level=0
            output_direc="/home/Drive2/aditya/Normalized_Data/Validation/InSitu/"
            #output_direc=dirlist[0].replace("/*png","/")
            if not os.path.exists(output_direc):
                os.makedirs(output_direc)
        #source_filename="/home/Drive2/aditya/Data/Photos/Validation/InSitu/is081.png"
        ...
        dirlist = ['/home/Drive2/aditya/Data/Photos/Training/Benign/',
        '/home/Drive2/aditya/Data/Photos/Training/InSitu/',
        '/home/Drive2/aditya/Data/Photos/Training/Invasive/',
        '/home/Drive2/aditya/Data/Photos/Training/Normal/',
        '/home/Drive2/aditya/Data/Photos/Validation/Benign/',
        '/home/Drive2/aditya/Data/Photos/Validation/InSitu/',
        '/home/Drive2/aditya/Data/Photos/Validation/Invasive/',
        '/home/Drive2/aditya/Data/Photos/Validation/Normal/']

        for m in range(len(dirlist)):
            if m != 5:
                continue
            input_direc=dirlist[m]
            #input_direc="../../Downloads/01/"
            output_direc=dirlist[m].replace("/Data/Photos/","/Normalized_Data/")
            if not os.path.exists(output_direc):
                os.makedirs(output_direc)
            file_type="*.png"
