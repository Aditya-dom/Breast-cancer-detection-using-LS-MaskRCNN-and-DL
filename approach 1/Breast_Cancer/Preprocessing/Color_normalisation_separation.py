...
for m in range(len(dirlist)):
    ...
    for filename in sorted(glob.glob(dirlist[m])):
        ...
        print(image_name)
        if m == 0:
            path = '/home/Drive2/aditya/Normalized_Data/Training/Benign/'
        elif m == 1:
            path = '/home/Drive2/aditya/Normalized_Data/Training/Normal/'
        elif m == 2:
            path = '/home/Drive2/aditya/Normalized_Data/Training/InSitu/'
        elif m == 3:
            path = '/home/Drive2/aditya/Normalized_Data/Training/Invasive/'
        elif m == 4:
            path = '/home/Drive2/aditya/Normalized_Data/Validation/Benign/'
        elif m == 5:
            path = '/home/Drive2/aditya/Normalized_Data/Validation/InSitu/'
        elif m == 6:
            path = '/home/Drive2/aditya/Normalized_Data/Validation/Invasive/'
        elif m == 7:
            path = '/home/Drive2/aditya/Normalized_Data/Validation/Normal/'
        normalised = color_normalization(filename,Wi, Hi,2,path+image_name+".png",0.02)
        print(m,ct)
        ct+=1
...
for line in f_in:
    line=line.rstrip()
    source_path=str(line)
    print source_path
    #target_path='PrognosisTMABlock1_A_3_1_H&E1.tif'
    save_path=line.replace("TCGA_breast_40x","TCGA_breast_40x_normalized")
    #os.mkdir(dirname)
    normalised=color_normalization(source_path,Wi, Hi,2,save_path,0.02)
    count000=count000+1
    print count000
"""
