...
best_epoch_weights = "/home/Drive2/aditya/Weights/best_weights_30_1_128128.h5"
last_epoch_weights = "/home/Drive2/aditya/Weights/last_weights_30_1_128128.h5"
initial_weights = '/home/Drive2/aditya/Weights/old_weights/last_weights_copy.h5'
batch_size = 50
epochs1 = 50
epochs2 = 50
####################################################################
...
x = Dense(128, activation='relu', name='fool_con1')(x)
x = Dense(128, activation='relu', name='fool_con2')(x)
#x = Dense(256, activation='relu', name='fool_con2')(x)
