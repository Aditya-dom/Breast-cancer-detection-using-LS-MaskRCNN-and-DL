...
#Parameters
######################################################################
benign_ss_path  = "/home/Drive2/aditya/fold1/benign_patches_info.npy"
normal_ss_path  = "/home/Drive2/aditya/fold1/normal_patches_info.npy"
insitu_ss_path  = "/home/Drive2/aditya/fold1/insitu_patches_info.npy"
invasive_ss_path  = "/home/Drive2/aditya/fold1/invasive_patches_info.npy"
...
with open('/home/Drive2/aditya/fold1/Benign.txt', 'rb') as f:
    benign = pickle.load(f)
with open('/home/Drive2/aditya/fold1/InSitu.txt', 'rb') as f:
    insitu = pickle.load(f)
with open('/home/Drive2/aditya/fold1/Invasive.txt', 'rb') as f:
    invasive = pickle.load(f)
with open('/home/Drive2/aditya/fold1/Normal.txt', 'rb') as f:
...
for i in range(no_samples):
    ...
    if insitu_class == 0 or insitu_class == 3 or insitu_class == 2:
        for j in range(insitu_ss[i]):
            shutil.copyfile("/home/Drive2/aditya/Aug_Data1/Validation/InSitu/"+str(i)+"_"+str(j)+".png","/home/Drive2/aditya/fold1/Wrong_Class/InSitu/"+str(i)+"_"+str(j)+"_TC_"+str(insitu_class)+"_AC_1_PC_"+str(int(insitu[i][j]))+".png")
    ...
    if invasive_class == 0 or invasive_class == 3 or invasive_class == 1:
        for j in range(invasive_ss[i]):
            shutil.copyfile("/home/Drive2/aditya/Aug_Data1/Validation/Invasive/"+str(i)+"_"+str(j)+".png","/home/Drive2/aditya/fold1/Wrong_Class/Invasive/"+str(i)+"_"+str(j)+"_TC_"+str(invasive_class)+"_AC_2_PC_"+str(int(invasive[i][j]))+".png")       
    ...
    if normal_class == 0 or normal_class == 2 or normal_class == 1:
        for j in range(normal_ss[i]):
            shutil.copyfile("/home/Drive2/aditya/Aug_Data1/Validation/Normal/"+str(i)+"_"+str(j)+".png","/home/Drive2/aditya/fold1/Wrong_Class/Normal/"+str(i)+"_"+str(j)+"_TC_"+str(normal_class)+"_AC_3_PC_"+str(int(normal[i][j]))+".png")
